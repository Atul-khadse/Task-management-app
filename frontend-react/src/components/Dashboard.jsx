  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-tr from-slate-500 to-slate-800 flex flex-col">
      ...
      <div className="w-full bg-white shadow-md p-4 flex justify-between items-center">
        ...
        <button className="px-6 py-3 m-2 bg-gradient-to-r from-gray-700 to-gray-900 text-white rounded-lg transition-all duration-300 transform hover:scale-110 hover:shadow-xl active:scale-95">
          Logout
        </button>
      </div>
